...
- **Tarifa de avaliação:** com simulação oficial anexada, os custos usam a tarifa de avaliação e o seguro à vista do próprio PDF. Sem PDF, usam o valor conferido por banco (`PARAM.avaliacaoPorBanco`, hoje Caixa R$ 841,44) e, para bancos ainda sem valor conferido, a estimativa média de R$ 3.000. A origem do valor aparece ao lado do custo.
